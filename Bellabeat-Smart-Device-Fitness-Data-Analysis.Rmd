...
ggplot(data = daily_sleep,mapping = aes(x= total_time_in_bed, y = total_minutes_asleep)) + geom_point() + geom_smooth(method = "lm") + theme_linedraw() + labs(title = "Sleep vs Time in bed", x = "minutes in bed", y = "minutes asleep")
...
```{r}
# sleep vs sedentary
ggplot(data = daily_sleep, mapping = aes(x = sedentary_minutes, y = total_minutes_asleep)) + geom_point() + geom_smooth(method = "lm") + theme_linedraw() + labs(title = "Sleep vs Sedentary", x = "sedentary minutes", y = "minutes asleep")
