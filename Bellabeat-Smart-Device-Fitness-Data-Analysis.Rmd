...
```{r}
#sleep vs steps
daily_sleep <- inner_join(daily_sleep, daily_activity[ , c("id", "activity_date", "total_steps", "sedentary_minutes")], by = c("id" = "id", "sleep_day" = "activity_date"))
...
daily_activity$total_intensities_minutes <- sum(daily_activity$lightly_active_minutes, daily_activity$fairly_active_minutes, daily_activity$very_active_minutes)

ggplot(data = daily_activity, mapping = aes(x = total_intensities_minutes, y = calories)) + geom_point() +geom_smooth(method = "ml") + theme_linedraw()
